...
public class Main {
    public static void main(String[] args) {
        ...
        Song[] availableSongs = {
                new Song("Song 1", "Artist A", 210, "Pop", false),
                new Song("Song 2", "Artist B", 180, "Rock", true),
                new Song("Song 3", "Artist C", 240, "Jazz", true),
                new Song("Song 4", "Artist D", 200, "Classical", false),
        };

...
public class SinglyLinkedPlaylistManager {
    ...
    public void addFavoriteSong(Song newSong) {
        ...
        if(head==null){
            head = new Node(newSong);
            current = head;
            System.out.println("Added first song: "+newSong);
            return;
        }
        ...
        while(temp!=null){
            if(temp.song.equals(newSong)){
                System.out.println("Song already exists: "+newSong);
                return;
            }
            temp = temp.next;
        }
    ...
    public void removeFavoriteSong(int index) {
        ...
        if(index==1){
            System.out.println("Removed song: "+head.song);
            head=head.next;
            return;
        }
        ...
        System.out.println("Removed song: "+current.song);
    ...
    public void playNextFavoriteSong() {
        ...
        System.out.println("Playing song: "+current.song);
    }
    ...
    public void playPreviousFavoriteSong() {
        ...
        current = temp;
        System.out.println("Now playing previous song: " + current.song);
